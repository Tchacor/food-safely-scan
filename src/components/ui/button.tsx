  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-danger text-danger-foreground hover:bg-danger/90 shadow-alert",
        outline: "border border-card-border bg-card hover:bg-accent hover:text-accent-foreground",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-hover shadow-card",
        ghost: "hover:bg-accent hover:text-accent-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        // Kitchen-specific variants
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-card",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-alert",
        fresh: "bg-fresh text-white hover:bg-fresh/90 shadow-card",
        valuable: "bg-valuable text-white hover:bg-valuable/90 shadow-card",
        hero: "bg-gradient-hero text-white hover:shadow-lg shadow-card border border-primary/20",
      },
      size: {
